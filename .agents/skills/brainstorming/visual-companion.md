...
.agents/skills/brainstorming/scripts/start-server.sh --project-dir /path/to/project --open
...
.agents/skills/brainstorming/scripts/start-server.sh --project-dir /path/to/project --open --foreground
```
...
bash .agents/skills/brainstorming/scripts/start-server.sh --project-dir /path/to/project --open --foreground
```
